...
public class Entity implements Movable {
    ...
    // the reason for using this method to setup the entity instead of using constructor is the
    // following:
    // we want to create all entities before the game begins to minimize garbage collection as much as
    // possible
