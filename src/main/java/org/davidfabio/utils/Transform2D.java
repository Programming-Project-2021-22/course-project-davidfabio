...
public class Transform2D {
    ...
    public static float getRandomX(Level level) {
        return (float)(Math.random() * level.getWidth());
    }
    public static float getRandomY(Level level) {
        return (float)(Math.random() * level.getHeight());
    }
